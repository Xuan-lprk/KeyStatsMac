...
> Status: **Implemented / Historical**. The Windows project now contains the localization resources and implementation described here; retain this document as execution history rather than a pending plan.
